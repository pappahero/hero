...
class CRequest {
  ...
  public function Init($baseUrl = null, $routing=null) {
    ...
    // Innehåller den url man är på just nu, den man frågade efter dock inte
    // basen utan bara den sista delen /~hero10/hero/developer/display-object
    $scriptName = $_SERVER['SCRIPT_NAME'];
    // Innehåller det nuvarande scriptets path --> Det är hit .htaccess leder    
    // /~hero10/hero/index.php
    ...
    // developer/display-object det vill säga det som kommer efter /~hero10/hero/
