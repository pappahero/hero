...
class CMModules extends CObject {
   ...
   * Properties
   */
  private $heroCoreModules = array('CHero', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $heroCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
  ...
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isLydiaCore']   = in_array($rc->name, $this->heroCoreModules);
      $details['isLydiaCMF']    = in_array($rc->name, $this->heroCMFModules);
