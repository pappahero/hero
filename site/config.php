 ...
 */
$he->config['debug']['lydia'] = false;
$he->config['debug']['session'] = false;
$he->config['debug']['timer'] = true;
$he->config['debug']['db-num-queries'] = true;
$he->config['debug']['db-queries'] = true;


/**
 * Set database(s).
 */
$he->config['database'][0]['dsn'] = 'sqlite:' . HERO_SITE_PATH . '/data/.ht.sqlite';
 ...
 */
$he->config['url_type'] = 1;


/**
 * Set a base_url to use another than the default calculated
 */
$he->config['base_url'] = null;


/**
 * How to hash password of new users, choose from: plain, md5salt, md5, sha1salt, sha1.
 */
$he->config['hashing_algorithm'] = 'sha1salt';


/**
 * Allow or disallow creation of new user accounts.
 */
$he->config['create_new_users'] = true;


/**
 * Define session name
 */
$he->config['session_name'] = preg_replace('/[:\.\/-_]/', '', __DIR__);
$he->config['session_key']  = 'lydia';


/**
 * Define default server timezone when displaying date and times to the user. All internals are still UTC.
 */
$he->config['timezone'] = 'Europe/Stockholm';


/**
 * Define internal character encoding
 */
$he->config['character_encoding'] = 'UTF-8';


/**
 * Define language
 */
$he->config['language'] = 'en';
 ...
 */
$he->config['controllers'] = array(
  'index'     => array('enabled' => true,'class' => 'CCIndex'),
  'developer' => array('enabled' => true,'class' => 'CCDeveloper'),
  'theme'     => array('enabled' => true,'class' => 'CCTheme'),
  'guestbook' => array('enabled' => true,'class' => 'CCGuestbook'),
  'medemobbook' => array('enabled' => true,'class' => 'CCMedEmobBook'),
  'testbook' => array('enabled' => true,'class' => 'CCTestBook'),
 ...
 * Define menus.
 *
 * Create hardcoded menus and map them to a theme region through $he->config['theme'].
 */
$he->config['menus'] = array(
  'navbar' => array(
  ...
  'my-navbar' => array(
    ...
    'bbcode' => array('label'=>'BBCode', 'url'=>'my/bbcode'),
    'testbook'      => array('label'=>'Contacts', 'url'=>'testbook'),
  ),
);
 ...
 * Template files can reside in the parent or current theme, the CHero::ThemeEngineRender()
 ...
 *
 * path: Path to current theme, relativly HERO_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
 ...
 */
$he->config['theme'] = array(
  'path'            => 'site/themes/herotheme',
  // 'path'            => 'themes/grid',
  'parent'          => 'themes/grid',
  ...
  'data' => array(
    'header' => 'Välkommen',
    'slogan' => 'till ett PHP-baserat MVC-inspirerat CMF',
    'favicon' => 'logo_80x80.png',
    'logo' => 'hero.gif',
    'logo_width'  => 172,
    'logo_height' => 64,
    'footer' => '<p>Hero &copy; by Henrik Rödén (karlhenrikroden@gmail.com)</p>',
  ),
);