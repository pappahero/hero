...
* the url 'developer/dump' would instantiate the controller with the key "developer", 
* that is CCDeveloper and call the method "dump" in that class. This process is managed 
* in: $ly->FrontControllerRoute();
